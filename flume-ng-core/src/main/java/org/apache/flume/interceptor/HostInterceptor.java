 ...
 *
 */
public class HostInterceptor extends AbstractInterceptor {
    ...
    private HostInterceptor(boolean preserveExisting,
                            boolean useIP, String header, String name) {
        this.name = name;
    ...
    public static class Builder implements Interceptor.Builder {
        ...
        public Interceptor build() {
            return new HostInterceptor(preserveExisting, useIP, header, name);
        }
        ...
        public void configure(Context context) {
            ...
            header = context.getString(AbstractInterceptor.NAME_CONFG, name);
        }
